            ...
            <Row gutter={[10, 10]}>
                ...
                <Col span={8}>
                    <Form.Item
                        ...
                        rules={[
                            { required: true, message: "Bán kính vòng quay phải là số" },
                            { type: 'number', min: 0, max: 40, message: 'Bán kính vòng quay là số từ 0 đến 40' }
                        ]}
                        name="ban_kinh_vong_quay"
                    >
                        <InputNumber placeholder="từ 0 đến 40" style={{ width: '100%' }} />
                    </Form.Item>
                </Col>
            </Row>
            <Form.Item>
